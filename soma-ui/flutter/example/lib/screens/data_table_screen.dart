  ...
  Widget build(BuildContext context) {
    ...
    return ComponentPage(
      ...
      preview: SomaDataTable(
        ...
        density: _compact
            ? SomaDataTableDensity.compact
            : SomaDataTableDensity.comfortable,
        toolbar: Wrap(
          spacing: 8,
          children: [
            SomaButton(
        ...
        cellBuilder: (context, column, value, row) {
          if (column.key != 'status') return Text(value);
          final variant = switch (value) {
            'Active' => SomaBadgeVariant.success,
            'Away' => SomaBadgeVariant.secondary,
            _ => SomaBadgeVariant.destructive,
          };
          return SomaBadge(variant: variant, child: Text(value));
        },
      ),
      controls: Column(
        ...
        children: [
          ...
          Row(children: [
            ...
            SomaSwitch(
                value: _filterable,
                onChanged: (v) => setState(() => _filterable = v)),
          ]),
          const SizedBox(height: 12),
          Row(children: [
            SizedBox(
          ...
          Row(children: [
            SizedBox(
              width: 120,
              child: Text(
                  'Page size: ${_pageSize.toInt() == 0 ? "off" : _pageSize.toInt()}',
                  style: TextStyle(
                      color: c.mutedForeground,
                      fontFamily: 'Outfit',
                      fontSize: 13)),

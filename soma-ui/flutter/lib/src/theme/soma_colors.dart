...
class SomaColors {
  ...
  static final SomaColors light = SomaColors(
    ...
    destructive: _hsl(6, 62, 52),
    destructiveForeground: _hsl(0, 0, 100),
    success: _hsl(160, 55, 38),
    successForeground: _hsl(0, 0, 100),
    warning: _hsl(25, 92, 52),
    warningForeground: _hsl(30, 30, 12),
    info: _hsl(214, 80, 52),
  ...
  static final SomaColors dark = SomaColors(
    ...
    destructive: _hsl(6, 60, 56),
    destructiveForeground: _hsl(0, 0, 100),
    success: _hsl(160, 48, 47),
    successForeground: _hsl(0, 0, 100),
    warning: _hsl(28, 88, 58),
    warningForeground: _hsl(30, 30, 12),
    info: _hsl(214, 74, 62),
    infoForeground: _hsl(0, 0, 100),
